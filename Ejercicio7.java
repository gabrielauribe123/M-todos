...
public class Ejercicio7 {
        ...
        public static void main(String[] args) {
            int cantidad = Integer.parseInt(JOptionPane.showInputDialog("¿Cuántas calificaciones quiere ingresar?"));
            double[] calificaciones = new double[cantidad];
            for (int i = 0; i < cantidad; i++) {
                calificaciones[i] = Double.parseDouble(JOptionPane.showInputDialog("Ingrese la calificación " + (i + 1)));
            }
